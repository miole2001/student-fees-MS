            ...
            <table id="datatablesSimple">
                ...
                <tbody>
                    ...
                    if (isset($_GET['delete_id'])) {
                        ...
                        if ($result) {
                            echo "<script>alert('Delete Successful!'); window.location.href = 'fourth-yr.php';</script>";
                        } else {
                            echo "<script>alert('Delete Unsuccessful. There was an error deleting the student.'); window.location.href = 'fourth-yr.php';</script>";
                        }
                        $stmt->close();
                    }
                    // Fetch student records to display
                    $sql = "SELECT * FROM accounts WHERE year_level = '4th' ORDER BY id DESC";
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        if ($stmt->execute()) {
                            echo "<script>alert('Update Successful!'); window.location.href = 'fourth-yr.php';</script>";
                        } else {
                            echo "<script>alert('Update Unsuccessful. Error: " . $stmt->error . "'); window.location.href = 'fourth-yr.php';</script>";
                        }
    ...
    <script>
        function confirmDelete(id) {
            if (confirm('Are you sure you want to delete this entry?')) {
                window.location.href = 'fourth-yr.php?delete_id=' + id;
            }
        }
